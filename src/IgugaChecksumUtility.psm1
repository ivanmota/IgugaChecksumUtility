$Script:LocalizedData = DATA {
    ...
    ValidationEmailNotificationTotalFileNotFound= - Total files not found:
    ValidationEmailNotificationTotalFailed= - Total failed:
    ValidationEmailNotificationTotalItems= - Total of items:
    ValidationEmailNotificationTotalPassed= - Total passed:
