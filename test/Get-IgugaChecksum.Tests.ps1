...
Describe 'Get-IgugaChecksum' {
    ...
    It 'Passe default algorithm (SHA256)' {
        ...
        (Get-IgugaChecksum -FilePath $FilePath).Checksum | Should -BeExactly -ExpectedValue $expected
    }
    ...
    It 'Passe default algorithm with relative file path' {
        ...
        $FilePath = $(Join-Path -Path $ModuleTestPath -ChildPath "Data\File.docx")
        $expected = "$hash  $($FilePath.Replace("\", "/"))"
        (Get-IgugaChecksum -FilePath "./Data/File.docx").Checksum | Should -BeExactly -ExpectedValue $expected
    }
    ...
    It 'Passe default algorithm with alternactive file path' {
        ...
        (Get-IgugaChecksum -FilePath $FilePath -AlternactiveFilePath ".\Data\File.docx").Checksum | Should -BeExactly -ExpectedValue $expected
    }
    ...
    It 'Passe with algorithm MD5' {
        ...
        $FilePath = $(Join-Path -Path $ModuleTestPath -ChildPath "Data\File.docx")
        $Expected = "$Hash  ./Data/File.docx"
        (Get-IgugaChecksum -FilePath $FilePath -Algorithm MD5 -AlternactiveFilePath ".\Data\File.docx").Checksum | Should -BeExactly -ExpectedValue $Expected
    }
    ...
    It 'Passe with algorithm SHA1' {
        ...
        $FilePath = $(Join-Path -Path $ModuleTestPath -ChildPath "Data\File.docx")
        $Expected = "$Hash  ./Data/File.docx"
        (Get-IgugaChecksum -FilePath $FilePath -Algorithm SHA1 -AlternactiveFilePath ".\Data\File.docx").Checksum | Should -BeExactly -ExpectedValue $Expected
    }
    ...
    It 'Passe with algorithm SHA512' {
        ...
        $FilePath = $(Join-Path -Path $ModuleTestPath -ChildPath "Data\File.docx")
        $Expected = "$Hash  ./Data/File.docx"
        (Get-IgugaChecksum -FilePath $FilePath -Algorithm SHA512 -AlternactiveFilePath ".\Data\File.docx").Checksum | Should -BeExactly -ExpectedValue $Expected
    }
}